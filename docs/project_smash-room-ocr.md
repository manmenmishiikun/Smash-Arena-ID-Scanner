...
- **`docs/future_notes.md`**: 今後やりたい内容・検討アイデアのメモ。未確定の将来タスクはここへ追記する。

# 最終更新日

2026-04-16（ドキュメント運用整理: `docs/extension-bridge-test-plan.md` を削除し、未確定タスク用に `docs/future_notes.md` を新設。）
